...
#ifndef GPUPIXEL_SWIFT_H
#define GPUPIXEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gpupixel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8gpupixel11FiterHandle")
@interface FiterHandle : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface FiterHandle (SWIFT_EXTENSION(gpupixel)) <RTCBeautyFilterDelegate>
- (void)didReceivePixelBuffer:(CVPixelBufferRef _Null_unspecified)pixelBuffer width:(int32_t)width height:(int32_t)height;
- (void)didReceiveLocalPixelBuffer:(CVPixelBufferRef _Null_unspecified)pixelBuffer width:(int32_t)width height:(int32_t)height;
@end
